        ...
        <div className="relative min-h-screen overflow-hidden bg-[#030712]">
            ...
            <main className="relative z-20 mx-auto grid min-h-screen w-full max-w-7xl gap-10 px-4 pb-8 pt-24 md:px-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-center lg:px-12">
                <section className="order-1 space-y-7 rounded-3xl border border-slate-100/10 bg-slate-950/52 p-6 shadow-[0_24px_90px_rgba(2,6,23,0.58)] backdrop-blur-sm sm:p-8 lg:pr-6 lg:p-10">
                    ...
                    <h1 className="relative max-w-[15ch] text-4xl leading-[1.05] text-slate-50 [text-shadow:0_8px_26px_rgba(2,6,23,0.9)] sm:text-5xl lg:text-[3.65rem]">
                    ...
                    <div className="w-full max-w-md rounded-[1.75rem] border border-cyan-100/20 bg-slate-950/72 p-6 shadow-[0_20px_80px_rgba(3,7,18,0.6)] backdrop-blur-2xl sm:p-8">
                        <div className="mb-7 flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <h2 className="mt-1 text-2xl font-semibold text-slate-100">Criar conta no ApplyHub</h2>
                            </div>
                        </div>
                        ...
                        {success ? (
                            <div className="py-2 text-center">
                                ...
                                <h3 className="text-xl font-semibold text-slate-100">Confirme seu email</h3>
                                <p className="mb-6 mt-2 text-sm text-slate-300">
                                    Enviamos um link de confirmacao para <strong className="text-slate-100">{email}</strong>.
                                </p>
                                <Link
                                    href="/login"
                                    className="inline-flex items-center justify-center rounded-lg border border-cyan-300/35 bg-cyan-300/10 px-4 py-2 text-sm font-medium text-cyan-100 transition-colors hover:bg-cyan-300/20"
                                >
                                    Voltar para login
                                </Link>
                            </div>
