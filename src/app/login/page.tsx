...
export default function LoginPage() {
    ...
    return (
        <div className="relative min-h-screen overflow-hidden bg-[#030712]">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_10%_15%,rgba(14,165,233,0.22),transparent_32%),radial-gradient(circle_at_85%_85%,rgba(37,99,235,0.22),transparent_35%)]" />
                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="rounded-2xl border border-slate-700/70 bg-slate-900/70 p-8 backdrop-blur-xl">
                        ...
                        <p className="mb-6 mt-1 text-sm text-slate-400">
                            Sign in to continue your application pipeline.
                        </p>
